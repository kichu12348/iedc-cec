...
`,qC="/iedc-cec/assets/rolls-BUkKg_rj.mp3";function KC(){const[t,e]=ze.useState(3),n=ze.useRef(null),i=ze.useRef(null),r=ze.useRef(null),s=ze.useRef(null),o=ze.useRef(null),a=ze.useRef(null),l=ze.useRef(null);ze.useEffect(()=>{if(window.innerWidth<768){e(2);return}else e(3)},[window.innerWidth]);const c=()=>{n.current.scrollIntoView({behavior:"smooth"})},d=()=>{i.current.scrollIntoView({behavior:"smooth"})},f=()=>{r.current.scrollIntoView({behavior:"smooth"})},h=()=>{s.current.scrollIntoView({behavior:"smooth"})},m=()=>{o.current.scrollIntoView({behavior:"smooth"})},_=()=>{a.current.scrollIntoView({behavior:"smooth"})},y=()=>{l.current.scrollIntoView({behavior:"smooth"})},p=new Audio(qC);p.preload="auto";const u=()=>{let v=!0;v&&(p.play(),v=!1,setTimeout(()=>{p.pause(),p.currentTime=0,v=!0},1e4))};return M.jsx(xc.Provider,{value:u,children:M.jsxs(ZC,{children:[M.jsx(KS,{scrollToHome:c,scrollToInspi:d,scrollToAnoucements:f,scrollToAchivement:h,scrollToWhoWeAre:m,scrollToTeam:_,scrollToTestimonials:y}),M.jsx(yC,{width:t,ref:n}),M.jsx(CC,{ref:i}),M.jsx(DC,{ref:r}),M.jsx(IC,{ref:s}),M.jsx(OC,{ref:o}),M.jsx(zC,{ref:a}),M.jsx(HC,{ref:l}),M.jsx($C,{scrollToHome:c,scrollToInspi:d,scrollToAnoucements:f,scrollToAchivement:h,scrollToWhoWeAre:m,scrollToTeam:_,scrollToTestimonials:y})]})})}const ZC=mt.div`
  height: auto;
  width: 100svw;
  ...
  position: relative;
  overflow-x: hidden;
`;Ou.createRoot(document.getElementById("root")).render(M.jsx(hn.StrictMode,{children:M.jsx(KC,{})}));
