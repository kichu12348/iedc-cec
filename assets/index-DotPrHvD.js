...
`,qC="/iedc-cec/assets/rolls-BUkKg_rj.mp3",KC="/iedc-cec/assets/sura-DqKwISPC.mp3";function ZC(){const[t,e]=ze.useState(3),n=ze.useRef(null),i=ze.useRef(null),r=ze.useRef(null),s=ze.useRef(null),o=ze.useRef(null),a=ze.useRef(null),l=ze.useRef(null);ze.useEffect(()=>{if(window.innerWidth<768){e(2);return}else e(3)},[window.innerWidth]);const c=()=>{n.current.scrollIntoView({behavior:"smooth"})},d=()=>{i.current.scrollIntoView({behavior:"smooth"})},f=()=>{r.current.scrollIntoView({behavior:"smooth"})},h=()=>{s.current.scrollIntoView({behavior:"smooth"})},m=()=>{o.current.scrollIntoView({behavior:"smooth"})},_=()=>{a.current.scrollIntoView({behavior:"smooth"})},y=()=>{l.current.scrollIntoView({behavior:"smooth"})},p=new Audio(qC);p.preload="auto";const u=new Audio(KC);u.preload="auto";const v=g=>{let S=!0;S&&g!==1&&(p.play(),S=!1,setTimeout(()=>{p.pause(),p.currentTime=0,S=!0},1e4)),S&&g===1&&(u.play(),S=!1,setTimeout(()=>{u.pause(),u.currentTime=0,S=!0},2e3))};return M.jsx(xc.Provider,{value:v,children:M.jsxs(QC,{children:[M.jsx(KS,{scrollToHome:c,scrollToInspi:d,scrollToAnoucements:f,scrollToAchivement:h,scrollToWhoWeAre:m,scrollToTeam:_,scrollToTestimonials:y}),M.jsx(yC,{width:t,ref:n}),M.jsx(CC,{ref:i}),M.jsx(DC,{ref:r}),M.jsx(IC,{ref:s}),M.jsx(OC,{ref:o}),M.jsx(zC,{ref:a}),M.jsx(HC,{ref:l}),M.jsx($C,{scrollToHome:c,scrollToInspi:d,scrollToAnoucements:f,scrollToAchivement:h,scrollToWhoWeAre:m,scrollToTeam:_,scrollToTestimonials:y})]})})}const QC=mt.div`
  height: auto;
  width: 100svw;
